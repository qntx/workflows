...
expect_ok 'CARGO_TARGET_RUNNER' $'CARGO_TARGET_AARCH64_UNKNOWN_LINUX_GNU_RUNNER=qemu-aarch64\n' $'CARGO_TARGET_AARCH64_UNKNOWN_LINUX_GNU_RUNNER=qemu-aarch64'
expect_ok 'CARGO_TARGET_RUSTFLAGS' $'CARGO_TARGET_AARCH64_UNKNOWN_LINUX_GNU_RUSTFLAGS=-C link-arg=-fuse-ld=lld\n' $'CARGO_TARGET_AARCH64_UNKNOWN_LINUX_GNU_RUSTFLAGS=-C link-arg=-fuse-ld=lld'
...
expect_fail 'CARGO_TARGET_DIR' $'CARGO_TARGET_DIR=/tmp/elsewhere\n'
expect_fail 'CARGO_TARGET_TMPDIR' $'CARGO_TARGET_TMPDIR=/tmp\n'
